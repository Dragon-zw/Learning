...
![](https://cdn.nlark.com/yuque/0/2024/png/2555283/1734343960140-86c222f1-3f5c-466b-8659-14849f57f58f.png)

在 Prometheus 中一条告警规则主要由以下几部分组成：

+ 告警名称：用户需要为告警规则命名，当然对于命名而言，需要能够直接表达出该告警的主要内容
+ 告警规则：告警规则实际上主要由 `<font style="color:#DF2A3F;">PromQL</font>` 进行定义，其实际意义是当表达式（PromQL）查询结果持续多长时间（During）后触发告警
...
![](https://cdn.nlark.com/yuque/0/2024/jpeg/2555283/1734343953278-837ea66e-45bc-4ee5-b538-456c54379323.jpeg)
...
![](https://cdn.nlark.com/yuque/0/2024/png/2555283/1734343958205-8ff83759-2eb6-4555-a307-9ed4a172ec59.png)
...
![](https://cdn.nlark.com/yuque/0/2024/png/2555283/1734343953981-08404504-ebc7-464d-a8af-d452d6581033.png)
...
![](https://cdn.nlark.com/yuque/0/2024/png/2555283/1734343952990-008ea50f-7971-44a5-8fde-246a2c0fa898.png)

可以点击右上面的 `New Silence` 按钮新建一个静默通知：

![](https://cdn.nlark.com/yuque/0/2024/png/2555283/1734343954661-9f5bb1d2-0dd0-4382-ad74-af10d2c6bb16.png)
...
![](https://cdn.nlark.com/yuque/0/2024/png/2555283/1734343954588-532dc1fc-27de-4381-ada4-c2f1b3a1513c.png)

创建完成后还可以对该配置进行编辑或者让其过期等操作。此时在静默列表也可以看到创建的静默状态。

![](https://cdn.nlark.com/yuque/0/2024/png/2555283/1734343960328-9ffe811e-c84c-4ead-8db8-601c1daf82be.png)
...
![](https://cdn.nlark.com/yuque/0/2024/png/2555283/1734343958712-2a2060a2-d0c5-4b69-86d8-4a2aa9dce544.png)
...
![](https://cdn.nlark.com/yuque/0/2024/png/2555283/1734343955794-5311c39d-571a-488b-97c0-68aff446023b.png)
...
![](https://cdn.nlark.com/yuque/0/2024/png/2555283/1734343959904-7509e799-feeb-4351-9224-4420a1577c56.png)
...
我这里实现了一个简单的 webhook 程序，代码仓库地址：[https://github.com/cnych/promoter](https://github.com/cnych/promoter)，该程序支持在消息通知中显示报警图表。

首先在钉钉群中选择创建一个自定义的机器人：

![](https://cdn.nlark.com/yuque/0/2024/png/2555283/1734343959980-f4b8650b-ea44-4385-b0f2-6e1af92cfad7.png)

这里我们选择添加额外密钥的方式来验证机器人，其他两种方式可以忽略，需要记住该值，下面会使用：

![](https://cdn.nlark.com/yuque/0/2024/png/2555283/1734343983099-0d601d0c-2024-462d-82ea-cf081a7a14a6.png)

创建完成后会提供一个 webhook 的地址，该地址会带一个 acess_token 的参数，该参数下面也会使用：

![](https://cdn.nlark.com/yuque/0/2024/png/2555283/1734343961511-95a22da2-32ba-417b-a6ba-fa1169a2fce8.png)
...
![](https://cdn.nlark.com/yuque/0/2024/png/2555283/1734343961219-87aa6b25-32d3-4789-80c9-a653f579b565.png)

如果想同时给企业微信发送消息通知，则需要在上面的 Webhook 配置中增加企业微信相关的配置。首先在企业微信后台创建一个新的应用，用来接收消息通知：

![](https://cdn.nlark.com/yuque/0/2024/png/2555283/1734343961770-555384bb-11fa-4e01-9e6f-22b9d08e72b3.png)

创建完成后即可以获取 AgentId 值和 Secret 值，Secret 值就是 `global.wechat_api_secret`，AgentId 是 `wechat_config.agent_id` 的值：

![](https://cdn.nlark.com/yuque/0/2024/png/2555283/1734343961308-03414cf5-d65a-4dec-baee-c4df9f569d3c.png)
...
![](https://cdn.nlark.com/yuque/0/2024/png/2555283/1734343962014-69cad44f-7ffa-4d58-950d-197f68204f74.png)
...
![](https://cdn.nlark.com/yuque/0/2024/png/2555283/1734343962047-239d9324-c0cf-407d-bff0-658de033398b.png)
...
![](https://cdn.nlark.com/yuque/0/2024/png/2555283/1734343962209-c0b1cb08-b8cf-471b-bcc2-aba3ed617e73.png)

现在我们就可以直接使用记录规则的名称 `job:node_memory_MemFree_bytes:percent` 来进行查询了：

![](https://cdn.nlark.com/yuque/0/2024/png/2555283/1734343962815-a751cdcf-9037-4187-b8e8-3ffb4ccc75f2.png)
